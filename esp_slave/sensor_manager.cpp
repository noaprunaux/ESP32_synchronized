...
// Variable pour mesurer le temps écoulé
unsigned long startTime;

// Fonction pour lire les capteurs
void readSensors() {
  if (startAcquisition) {  // Vérifie si l'acquisition doit commencer
...
void sendBuffer1() {
  client.publish("sensor3/data", buffer1);
}

// Fonction pour envoyer les données du buffer2 via MQTT
void sendBuffer2() {
  client.publish("sensor4/data", buffer2);
}
